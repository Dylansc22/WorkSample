...
$.getJSON("data/Topojson_ErosionRisk_Basin_Continents/SABasin.js", function (
  data
) {
...
$.getJSON("data/Topojson_ErosionRisk_Basin_Continents/NABasin.js", function (
  data
) {
...
$.getJSON("data/Topojson_ErosionRisk_Basin_Continents/ASBasin.js", function (
  data
) {
...
$.getJSON("data/Topojson_ErosionRisk_Basin_Continents/AFBasin.js", function (
  data
) {
...
$.getJSON("data/Topojson_ErosionRisk_Basin_Continents/AUBasin.js", function (
  data
) {
...
$.getJSON("data/Topojson_ErosionRisk_Basin_Continents/EUBasin.js", function (
  data
) {
...
$.getJSON("data/Topojson_ErosionRisk_Basin_Continents/OCBasin.js", function (
  data
) {
...
info.update = function (props) {
  this._div.innerHTML = props
    ? '<div class="propsformat"><h5>' +
      props.CNTRY_NAME /*FYI: theseCNTRY_NAMEs are case-sensitive when I make them in the topojson cmd line*/ +
      '</h5>: Country</div><br><div class="propsformat"><h6>' +
      props.MAX +
      "</h6>: Erosion Score</div><br>"
    : '<div class="propsformat"><h5>' +
      "" +
      '</h5> Country</div><br><div class="propsformat"><h6>' +
      "" +
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.CurrentForestCondition", {
    accessToken:
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.Conservation", {
    accessToken:
      "pk.eyJ1IjoiZHlsYW5jIiwiYSI6Im53UGgtaVEifQ.RJiPqXwEtCLTLl-Vmd1GWQ",
  }),
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.Restoration", {
    accessToken:
      "pk.eyJ1IjoiZHlsYW5jIiwiYSI6Im53UGgtaVEifQ.RJiPqXwEtCLTLl-Vmd1GWQ",
  }),
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.LandUseIntensity", {
    accessToken:
      "pk.eyJ1IjoiZHlsYW5jIiwiYSI6Im53UGgtaVEifQ.RJiPqXwEtCLTLl-Vmd1GWQ",
  }),
  "Land Use Intensity",
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.grunoff_n10", {
    accessToken:
      "pk.eyJ1IjoiZHlsYW5jIiwiYSI6Im53UGgtaVEifQ.RJiPqXwEtCLTLl-Vmd1GWQ",
  }),
  "Global Runoff",
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.AdjSlope_r10", {
    accessToken:
      "pk.eyJ1IjoiZHlsYW5jIiwiYSI6Im53UGgtaVEifQ.RJiPqXwEtCLTLl-Vmd1GWQ",
  }),
  "High Slope Lands",
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.glhymps_r10", {
    accessToken:
      "pk.eyJ1IjoiZHlsYW5jIiwiYSI6Im53UGgtaVEifQ.RJiPqXwEtCLTLl-Vmd1GWQ",
  }),
  "Permeability",
...
addLayer_primary(
  L.mapbox.tileLayer("dylanc.porosity_n10", {
    accessToken:
      "pk.eyJ1IjoiZHlsYW5jIiwiYSI6Im53UGgtaVEifQ.RJiPqXwEtCLTLl-Vmd1GWQ",
  }),
  "Porosity",
